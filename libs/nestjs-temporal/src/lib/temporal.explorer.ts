...
import { TEMPORAL_CORE_CONFIG, TEMPORAL_WORKER_CONFIG } from './temporal.constants';
  ...
  implements OnModuleInit, OnModuleDestroy, OnApplicationBootstrap
{
  ...
  getRuntimeConfigOptions(name?: string): RuntimeOptions {
